...
ofImage fire;
//--6--
float draw6Start = 2400;
ofImage sun;
ofImage drop;
int draw6Num = 0;
//--7--
float draw7Start = 3000;
int draw7Num = 0;
...
void ofApp::setup(){
	...
	sun.load("sun.png");
	drop.load("drop.png");
	ofSetFrameRate(70);				//to control the speed of the animation we generate
}
//--------------------------------------------------------------
void ofApp::update(){
	...
	draw7Num = frameNumber - draw7Start;
}
...
void draw5_Try() {
	...
	if (draw5Num <= 100) {
		...
		ofDrawCircle(ofGetWidth() - 250, ofGetHeight() - 120, 5, 5);

	}
	else if (draw5Num <= 500) {
		...
		ofDrawCircle(ofGetWidth() - 250, ofGetHeight() - 120, 5, 5);
		ofDrawCircle(ofGetWidth() - 200, ofGetHeight() - 120, 5, 5);
		

	}
	else if (draw5Num <= 550) {
		...
		ofDrawCircle(ofGetWidth() - 250, ofGetHeight() - 120, 5, 5);
		ofDrawCircle(ofGetWidth() - 200, ofGetHeight() - 120, 5, 5);
		ofDrawCircle(ofGetWidth() - 150, ofGetHeight() - 120, 5, 5);


	}
	else if (draw5Num <= 600) {
		...
		ofDrawCircle(ofGetWidth() - 200, ofGetHeight() - 120 , 5, 5);
		ofDrawCircle(ofGetWidth() - 150, ofGetHeight() - 120 , 5, 5);
		ofDrawCircle(ofGetWidth() - 100, ofGetHeight() - 120 , 5, 5);
...
void draw6_Sun() {
	...
	if (draw6Num <= 400) {
		ofSetColor(0);
		ofFill();
		sun.draw(draw6Num*.5, 150, 200,200);
		
		ofSetRectMode(OF_RECTMODE_CENTER);
		
		ofDrawRectangle(ofGetWidth() - 300, ofGetHeight() - 120, 7, 200);
		ofSetRectMode(OF_RECTMODE_CORNER);
		ofDrawRectangle(ofGetWidth() - 300-3.5, ofGetHeight() - 120+50, draw6Num*0.5,50);
		
		
	}
	else if (draw6Num<=600) {
		ofSetColor(0);
		ofFill();
		sun.draw(200, 150, 200, 200);
		ofSetRectMode(OF_RECTMODE_CENTER);

		ofDrawRectangle(ofGetWidth() - 300, ofGetHeight() - 120+(sin(ofGetFrameNum()*0.1) + abs(sin(ofGetFrameNum()*0.1)))*-80, 7, 200);
		ofSetRectMode(OF_RECTMODE_CORNER);
		ofDrawRectangle(ofGetWidth() - 300 - 3.5 + (sin(ofGetFrameNum()*0.1) + abs(sin(ofGetFrameNum()*0.1)))*80, ofGetHeight() - 120 + 50, 200, 50);
	}
...
void draw7_Escape() {
	...
	ofDrawRectangle(ofGetWidth() - 300 - draw7Num * 4, ofGetHeight() - 120 + (sin(ofGetFrameNum()*0.1) + abs(sin(ofGetFrameNum()*0.1)))*-80, 7, 200);
	ofSetRectMode(OF_RECTMODE_CORNER);
	ofDrawRectangle(ofGetWidth() - 300 - 3.5 - draw7Num * 4 + (sin(ofGetFrameNum()*0.1) + abs(sin(ofGetFrameNum()*0.1))) * 80, ofGetHeight() - 120 + 50, 200, 50);
}
